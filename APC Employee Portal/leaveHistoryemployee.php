...
<a href="leaveHistoryemployee.php" style="text-decoration: none; padding: 10px; font-size:20px; color:#f2f2f2; position:relative; top:-715px; text-align:left; float:left; left:5px; font-family:'Roboto';">History</a>
</div>
...
<thead>
  <tr>
	<th><a href="javascript:SortTable(1,'T')" style="font-size:20px;">Leave Type</a></th>
	<th><a href="javascript:SortTable(2,'D','mdy')" style="font-size:20px;">Begin Date</a></th>
	<th><a href="javascript:SortTable(3,'D','mdy')" style="font-size:20px;">End Date</a></th>
    ...
    <?php
		...
		if ($result->num_rows > 0) {
			while ($row = $result-> fetch_assoc()){
				echo "<tr><td>" . $row["leave_type"] . "</td><td>" . $row["begin_date"] . "</td><td>" . $row["end_date"] . "</td><td>" . $row["hours"] . "</td><td>" . $row["reason"] . "</td><td>" . $row["status"] . "</td>";
			}
		}
		else {
			echo "No Results";
...
<h2 style="font-size:30px;color:#202124;position:relative;top:-1020px;text-align:center;float:left;left:12px;font-family:'Roboto';">LEAVE HISTORY</h2>
...
<div class="sidenav">
  <a class="active" href="oboffsetHistoryemployee.php">OB/Offset History</a>
</div>
