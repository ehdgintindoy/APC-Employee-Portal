...
<div class="profile">
<a href="admin.php" style="text-decoration: none; padding: 10px; font-size:20px; color:#f2f2f2; position:relative; top:-699px; text-align:left; float:left; left:-160px; font-family:'Roboto';">Home</a>
...
<a href="leaveHistoryemployee.php" style="text-decoration: none; padding: 10px; font-size:20px; color:#f2f2f2; position:relative; top:-699px; text-align:left; float:left; left:-100px; font-family:'Roboto';">History</a>
<a href="admin.php" style="text-decoration: none; padding: 10px; font-size:20px; color:#f2f2f2; position:relative; top:-699px; text-align:left; float:left; left:-70px; font-family:'Roboto';">HR/Supervisor</a>
</div>

<div class="dropdown" style="float:right position: relative; top:-869px; right:-800px; font-family:'Roboto';">
...
<img src="envelope.png" style="width:35px; height:25px; position:relative; top:-90px; text-align:center; float:left; left:-560px;">

<a href="leaverequest.php">
<img src="request.png" style="width:200px; height:200px; position:relative; top:-455px; left:-300px;">
</a>

<a href="leavehistory.php">
<img src="history.png" style="width:200px; height:200px; position:relative; top:-455px; left:-200px;">
</a>

<a href="hr.php">
<img src="hr.png" style="width:200px; height:200px; position:relative; top:-455px; left:-100px;">
</a>
